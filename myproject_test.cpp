...
int main(int argc, char **argv)
{
  ...
  if (fin.is_open() && fpr.is_open()) {
    while ( std::getline(fin,iline) && std::getline (fpr,pline) ) {
      ...
      nnet::copy_data_switch<float, input_t, 0, 342, 6>(in, tracks);
      ...
      if (e % CHECKPOINT == 0) {
        ...
        nnet::print_result_switch<layer117_t, 7296, 128>(layer117_out, std::cout, true);
      }
      e++;

      //hls-fpga-machine-learning insert tb-output
      nnet::print_result_switch<layer117_t, 7296, 128>(layer117_out, fout);
