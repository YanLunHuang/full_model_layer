...
void myproject(
    hls::stream<input29_t> em_barrel[16], hls::stream<input13_t> scalars[1],
    ...
    nnet::film_switch<input29_t, input13_t, layer42_t, config42>(em_barrel, scalars, layer102_out); // fi_lm
}