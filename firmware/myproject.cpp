...
void myproject(
    hls::stream<input29_t> em_barrel[128], hls::stream<input13_t> scalars[128],
    hls::stream<layer11_t> layer102_out[128]
) {
    ...
    nnet::multiply_switch<input29_t, input13_t, layer11_t, config11>(em_barrel, scalars, layer102_out); // multiply
}
