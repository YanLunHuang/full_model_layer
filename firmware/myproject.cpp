...
void myproject(
    hls::stream<layer22_t> em_barrel[1], hls::stream<layer23_t> scalars[1],
    hls::stream<layer24_t> layer24_out[384]
) {

    //hls-fpga-machine-learning insert IO
    #pragma HLS INTERFACE axis port=em_barrel,scalars,layer102_out 
    #pragma HLS DATAFLOW 
    ...
    nnet::concatenate1d_switch<layer22_t, layer23_t, layer24_t, config24>(em_barrel, scalars, layer24_out); // concatenate
}
