...
template <class data_T, typename CONFIG_T>
void shift_line_buffer_ss( data_T in_elem[CONFIG_T::n_chan], 
    ...
    kernel_shift_2d_ss<data_T, CONFIG_T>(shift_buffer, kernel_window);
}
...
template<class data_T, class res_T, typename CONFIG_T>
void compute_output_buffer_2d_ss(
    //const data_T& in_elem,
    ...
    // Add pixel to buffer
    nnet::shift_line_buffer_ss<data_T, CONFIG_T>(in_elem, line_buffer, kernel_data);
