...
template<class data_T, class res_T, typename CONFIG_T>
void pointwise_mult_buffer_s2s(
    hls::stream<data_T> data_pack[1],
    hls::stream<res_T> res_stream[1],
    typename CONFIG_T::weight_t weights[CONFIG_T::n_chan * CONFIG_T::n_filt],
    typename CONFIG_T::bias_t biases[CONFIG_T::n_filt]
...
template<class data_T, class res_T, typename CONFIG_T>
void pointwise_mult_buffer_s2a(
    hls::stream<data_T> data_pack[1],
...
template<class data_T, class res_T, typename CONFIG_T>
void pointwise_mult_buffer_a2a(
    hls::stream<data_T> data_pack[CONFIG_T::n_chan],
    hls::stream<res_T> res_stream[CONFIG_T::n_filt],
    typename CONFIG_T::weight_t weights[CONFIG_T::n_chan * CONFIG_T::n_filt],
    typename CONFIG_T::bias_t biases[CONFIG_T::n_filt]
) {
...
template<class data_T, class res_T, typename CONFIG_T>
void pointwise_mult_buffer_a2s(
    hls::stream<data_T> data_pack[CONFIG_T::n_chan],
    hls::stream<res_T> res_stream[1],
    typename CONFIG_T::weight_t weights[CONFIG_T::n_chan * CONFIG_T::n_filt],
    typename CONFIG_T::bias_t biases[CONFIG_T::n_filt]
