    ...
    typename CONFIG_T::bias_t   biases[CONFIG_T::n_filt])
{
    assert(CONFIG_T::pad_left == 0 && CONFIG_T::pad_right == 0);
    assert(CONFIG_T::filt_width == 1);
    std::cout << "USE CONV1D_SS" << std::endl;
    ...
    ReadInputWidth: for (unsigned i_iw = 0; i_iw < CONFIG_T::in_width; i_iw++) {
        if (i_iw % CONFIG_T::stride_width == 0) {
            pointwise_mult_buffer_s2s<data_T, res_T, CONFIG_T>(data, res, weights, biases);
        } else {
            for(unsigned i = 0; i < CONFIG_T::n_chan; i++){
                #pragma HLS PIPELINE II=1
                data[0].read();
    ...
    typename CONFIG_T::bias_t   biases[CONFIG_T::n_filt])
{
    assert(CONFIG_T::pad_left == 0 && CONFIG_T::pad_right == 0);
    assert(CONFIG_T::filt_width == 1);
    std::cout << "USE CONV1D_SA" << std::endl;
    ...
    ReadInputWidth: for (unsigned i_iw = 0; i_iw < CONFIG_T::in_width; i_iw++) {
        if (i_iw % CONFIG_T::stride_width == 0) {
            pointwise_mult_buffer_s2a<data_T, res_T, CONFIG_T>(data, res, weights, biases);
        } else {
            for(unsigned i = 0; i < CONFIG_T::n_chan; i++){
                #pragma HLS PIPELINE II=1
                data[0].read();
    ...
    typename CONFIG_T::bias_t   biases[CONFIG_T::n_filt])
{
    assert(CONFIG_T::pad_left == 0 && CONFIG_T::pad_right == 0);
    assert(CONFIG_T::filt_width == 1);
    std::cout << "USE CONV1D_AA" << std::endl;
    ...
    ReadInputWidth: for (unsigned i_iw = 0; i_iw < CONFIG_T::in_width; i_iw++) {
        if (i_iw % CONFIG_T::stride_width == 0) {
            pointwise_mult_buffer_a2a<data_T, res_T, CONFIG_T>(data, res, weights, biases);
        } else {
            for(unsigned i = 0; i < CONFIG_T::n_chan; i++){
                #pragma HLS UNROLL
                data[i].read();
    ...
    typename CONFIG_T::bias_t   biases[CONFIG_T::n_filt])
{
    assert(CONFIG_T::pad_left == 0 && CONFIG_T::pad_right == 0);
    assert(CONFIG_T::filt_width == 1);
    std::cout << "USE CONV1D_AS" << std::endl;
    ...
    ReadInputWidth: for (unsigned i_iw = 0; i_iw < CONFIG_T::in_width; i_iw++) {
        if (i_iw % CONFIG_T::stride_width == 0) {
            pointwise_mult_buffer_a2s<data_T, res_T, CONFIG_T>(data, res, weights, biases);
        } else {
            for(unsigned i = 0; i < CONFIG_T::n_chan; i++){
                #pragma HLS UNROLL
                data[i].read();
...
template<class data_T, class res_T, typename CONFIG_T>
void pointwise_conv_1d_cl_switch(
    ...
    if(CONFIG_T::data_transfer_in == 1 && CONFIG_T::data_transfer_out == 1){
        pointwise_conv_1d_cl_s2s<data_T, res_T, CONFIG_T>(data, res, weights, biases);
    }else if(CONFIG_T::data_transfer_in == 1 && CONFIG_T::data_transfer_out != 1){
        pointwise_conv_1d_cl_s2a<data_T, res_T, CONFIG_T>(data, res, weights, biases);
    }else if(CONFIG_T::data_transfer_in != 1 && CONFIG_T::data_transfer_out != 1){
        pointwise_conv_1d_cl_a2a<data_T, res_T, CONFIG_T>(data, res, weights, biases);
    }else {
        pointwise_conv_1d_cl_a2s<data_T, res_T, CONFIG_T>(data, res, weights, biases);
    }
