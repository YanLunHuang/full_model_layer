...
`define TV_IN_em_barrel_15_V_V_TDATA "./c.myproject.autotvin_em_barrel_15_V_V.dat"
`define INGRESS_STATUS_em_barrel_15_V_V_TDATA "./stream_ingress_status_em_barrel_15_V_V.dat"
...
module AESL_axi_s_em_barrel_15_V_V (
    ...
    fifo #(57, 32) fifo_em_barrel_15_V_V_TDATA (
        .reset(1'b0),
        .write_clock(clk),
