...
hls::stream<ap_fixed<32, 16, (ap_q_mode) 5, (ap_o_mode)3, 0> > layer102_out[1]);
...
hls::stream<ap_fixed<32, 16, (ap_q_mode) 5, (ap_o_mode)3, 0> > layer102_out[1])
{
	...
	if (wrapc_switch_file_token.good())
	{
			...
			if (i > 0)
			{
				// RTL Name: layer102_out_0_V_V
				{
					...
					// {
						...
						// {
							sc_lv<32>* layer102_out_V_V_lv0_0_0_2 = new sc_lv<32>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: layer102_out.V.V(31, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								if (&(aesl_tmp_9[0]) != NULL) // check the null address if the c port is array or others
								{
									(aesl_tmp_9[i_0]).range() = (layer102_out_V_V_lv0_0_0_2[hls_map_index]).to_string(SC_BIN).c_str();
									hls_map_index++;
								}
							}
						}
		...
		{
			layer102_out[0].write(aesl_tmp_9[i]);
		}
	...
	else
	{
		...
		{
			aesl_tmp_9.push_back(layer102_out[0].read());
			aesl_tmp_10++;
		}
...
// [call_c_dut] ---------->
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		...
		sc_bv<32>* layer102_out_0_V_V_tvout_wrapc_buffer = new sc_bv<32>[aesl_tmp_10 - aesl_tmp_11];
				...
				// celement: layer102_out.V.V(31, 0)
				{
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						if (&(aesl_tmp_9[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							layer102_out_V_V_tmp_mem = (aesl_tmp_9[i_0]).range().to_string(SC_BIN).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.layer102_out_0_V_V_depth);
