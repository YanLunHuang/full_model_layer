...
set solution_dir "/home/YL_HUANG/10_21/clone_stream/myproject_prj/solution1"
...
set Interfaces {
    ...
    layer103_cpy1_0_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy1_0_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy1_1_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy1_1_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy1_2_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy1_2_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy1_3_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy1_3_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy1_4_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy1_4_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy1_5_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy1_5_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy2_0_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy2_0_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy2_1_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy2_1_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy2_2_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy2_2_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy2_3_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy2_3_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy2_4_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy2_4_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    layer103_cpy2_5_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer103_cpy2_5_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    ap_clk {
        ...
        buses "tracks_0_V_V tracks_1_V_V tracks_2_V_V tracks_3_V_V tracks_4_V_V tracks_5_V_V layer103_cpy1_0_V_V layer103_cpy1_1_V_V layer103_cpy1_2_V_V layer103_cpy1_3_V_V layer103_cpy1_4_V_V layer103_cpy1_5_V_V layer103_cpy2_0_V_V layer103_cpy2_1_V_V layer103_cpy2_2_V_V layer103_cpy2_3_V_V layer103_cpy2_4_V_V layer103_cpy2_5_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
